		...
		<div class="card">
			...
			<div class="body">
				...
				<ul class="nav nav-tabs tab-nav-right" role="tablist">
					<li role="presentation" class="active"><a href="#profile" data-toggle="tab" aria-expanded="true"> <i class="material-icons">dns</i> Update Profile</a>
					</li>
					<li role="presentation" class=""><a href="#password" data-toggle="tab" aria-expanded="false"> <i class="material-icons">security</i> Change Password</a></li>
				</ul>
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade active in" id="profile">
						<form class="form-horizontal" action="{{ route('author.setting.update.profile') }}" method="post"
							...
							<div class="row clearfix">
								<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
									<a href="{{ route('author.profile.index') }}" class="btn btn-danger m-t-10 waves-effect">BACK</a>
					...
					<div role="tabpanel" class="tab-pane fade" id="password">
						<form class="form-horizontal" action="{{ route('author.setting.update.password') }}" method="post"
							enctype="multipart/form-data">
							@csrf
							@method('PUT')
							...
							<div class="row clearfix">
								<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
									<a href="{{ route('author.profile.index') }}" class="btn btn-danger m-t-10 waves-effect">BACK</a>
									<button type="submit" class="btn btn-primary m-t-10 waves-effect">CHANGE</button>
								</div>
							</div>
						</form>
					</div>
