			...
			<div class="body">
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane fade active in" id="profile">
						<form class="form-horizontal" action="{{ route('admin.setting.update.profile') }}" method="post"
							...
							<div class="row clearfix">
								<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
									<a href="{{ route('admin.profile.index') }}" class="btn btn-danger m-t-10 waves-effect">BACK</a>
					...
					<div role="tabpanel" class="tab-pane fade" id="password">
						<form class="form-horizontal" action="{{ route('admin.setting.update.password') }}" method="post"
							enctype="multipart/form-data">
							@csrf
							@method('PUT')
