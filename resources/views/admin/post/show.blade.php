...
<div class="block-header" style="display: flex; align-items: center; justify-content: space-between">
	...
	@else
	<a href="{{ route('admin.post.approved', $post->id) }}" class="btn btn-warning waves-effect"><i
			class="material-icons">call_made</i> <span>Pending..</span></a>
	@endif
...
<div class="row clearfix">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<div class="card">
			...
			<div class="body">
                <img src="{{ Storage::disk('public')->url('post/'.$post->image) }}" class="img-fluid" alt="{{ $post->title }}">
				{!! $post->body !!}
			</div>
		</div>
	</div>
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		...
		<div class="card">
			...
			<div class="body">
				<img src="{{ Storage::disk('public')->url('post/'.$post->image) }}" class="img-thumbnail" width="320px"
					alt="{{ $post->title }}">
			</div>
		</div>
